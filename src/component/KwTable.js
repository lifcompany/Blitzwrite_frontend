                ...
                <table className="min-w-full">
                    <thead className="bg-white text-left p-2">
                        <tr>
                            ...
                            <th className="whitespace-nowrap px-8 py-3 w-[16%] font-bold text-gray-900 text-xs text-left">ボリューム</th>
                            <th className="whitespace-nowrap px-8 py-3 w-[40%] font-bold text-gray-900 text-xs text-left">ステータス</th>
                        </tr>
                    </thead>
                    ...
                    <tbody className="divide-y divide-gray-200 bg-gray-100">
                        {keyword_data.map((keyword, index) => (
                            <tr key={index}>
                                ...
                                <td className="whitespace-nowrap px-8 py-1 font-medium text-gray-900 text-[14px]">{keyword.name}</td>
